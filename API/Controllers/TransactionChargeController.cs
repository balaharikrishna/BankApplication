...
namespace API.Controllers
{
    ...
    public class TransactionChargeController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<TransactionChargesDto>>> GetTransactionCharges([FromRoute] string branchId)
        {
            try
            {
        ...
        public async Task<ActionResult<Message>> DeleteTransactionCharges([FromRoute] string branchId)
        {
            try
            {
