...
namespace BankApplicationServices.IServices
{
    public interface IBankService
    {
        ...
        /// <returns>Message Object about the Status of Bank Creation.</returns>
        Message CreateBank(string bankName);
        /// <summary>
        /// Deletes a Existing bank.
        /// </summary>
        /// <param name="bankId">BankId of the Bank</param>
        /// <returns>Message Object about the Status of Bank Deletion.</returns>
        ...
        /// <returns>A Message object containing information about the status of the operation and the exchange rates retrieved.</returns>
